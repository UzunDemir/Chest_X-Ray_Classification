...
st.sidebar.write(
    ...
    Модель предсказания будет в дальнейшем совершенствоваться и дообучаться на новых данных. Например на [этих](https://www.kaggle.com/datasets/nih-chest-xrays/data) 
    Есть идея создать полноценное приложение-ассистент рентгенолога, которое будет диагностировать около 13 заболеваний, которые можно выявить 
    при анализе рентгеновских снимков грудной клетки.
    """
)
